...
controlButtonSettingDialog::controlButtonSettingDialog(SimulationWidget* pWidget)
    : QDialog(pWidget){
...
////////////////////////////////////////////////////////////////////////////////
SimulationPlugin::SimulationPlugin(QObject *parent): QObject(parent)
{
    m_widget = NULL;
    m_dialog = NULL;
...
////////////////////////////////////////////////////////////////////////////////
QWidget *SimulationPlugin::createWidget(QWidget *parent, Database *pDatabase, HistoricalClient *histClient, void *data, int environ)
{
    m_widget = new SimulationWidget(parent, pDatabase, data, environ);
    return m_widget;
}

////////////////////////////////////////////////////////////////////////////////
bool SimulationPlugin::popupWidget(QWidget *parent, void *data)
{
    if(m_widget == NULL){
        return false;
    }
    ...
    this->m_widget = (SimulationWidget*)parent;
...
////////////////////////////////////////////////////////////////////////////////
void SimulationPlugin::setDataBase(Database *database)
{
    if (m_widget != NULL)
...
//////////////////////////////////////////////////////////////////////////////
void SimulationPlugin::setParent(QWidget *parent)
{
    if (m_widget != NULL)
...
void SimulationPlugin::setInterfaces(UserMSInterface* userIface,OperationLog* olog){
    if (m_widget != NULL)
        m_widget->setInterfaces(userIface,olog);
}

////////////////////////////////////////////////////////////////////////////////
QString SimulationPlugin::name() const
{
    //必须和target的name相同
...
////////////////////////////////////////////////////////////////////////////////
QString SimulationPlugin::group() const
{
...
////////////////////////////////////////////////////////////////////////////////
QString SimulationPlugin::toolTip() const
{
    return QString::fromUtf8("操作按钮");
}

////////////////////////////////////////////////////////////////////////////////
QString SimulationPlugin::whatsThis() const
{
    return QString::fromUtf8("操作按钮");
}

////////////////////////////////////////////////////////////////////////////////
bool SimulationPlugin::isContainer() const
{
    return false;
}
...
////////////////////////////////////////////////////////////////////////////////
QString SimulationPlugin::domSvg() const
{
    return "output svg for test";
}

////////////////////////////////////////////////////////////////////////////////
QString SimulationPlugin::domG() const
{
    return "output g for test";
}

void SimulationPlugin::startLog()
{
    static A static_aa;
}

////////////////////////////////////////////////////////////////////////////////
QString SimulationPlugin::includeFile() const
{
    return "controlButton_plugin.h";
}

////////////////////////////////////////////////////////////////////////////////
void* SimulationPlugin::getData()
{
    /*QMessageBox::information(NULL,"SimulationPlugin::getData", "XXX");

    if (m_widget != NULL)
        return (void*)((SimulationWidget*)m_widget)->getData().toUtf8().data();
    else*/
    return NULL;
}

////////////////////////////////////////////////////////////////////////////////
void SimulationPlugin::resize(int w, int h)
{
    if (m_widget != NULL)
        m_widget->resize(w, h);
}
...
Q_EXPORT_PLUGIN2(SimulationPlugin, SimulationPlugin)
